...
Elm.Main.make = function (_elm) {
   ...
   $Time = Elm.Time.make(_elm);
   var _op = {};
   var tasksMailbox = $Signal.mailbox($Task.succeed({ctor: "_Tuple0"}));
   var tasks = Elm.Native.Task.make(_elm).performSignal("tasks",
   tasksMailbox.signal);
   var Payload = function (a) {    return {card: a};};
   var render = F2(function (event,state) {
      var _p0 = event;
      switch (_p0.ctor)
      {case "Never": return state;
         case "DigitEntry0": return _U.update(state,
           {cardNumber0: _p0._0});
         case "DigitEntry1": return _U.update(state,
           {cardNumber1: _p0._0});
         case "DigitEntry2": return _U.update(state,
           {cardNumber2: _p0._0});
         case "DigitEntry3": return _U.update(state,
           {cardNumber3: _p0._0});
         case "HolderEntry": return _U.update(state,
           {cardHolderName: _p0._0});
         case "ExpirationMonthChange": return _U.update(state,
           {cardExpirationMonth: _p0._0});
         case "ExpirationYearChange": return _U.update(state,
           {cardExpirationYear: _p0._0});
         case "CCVEntry": return _U.update(state,{cardCCV: _p0._0});
         case "ToggleCCVFocus": return _U.update(state,
           {cardCCVfocused: $Basics.not(state.cardCCVfocused)});
         case "ToggleSubmit": return _U.update(state,
           {submitting: $Basics.not(state.submitting)});
         case "ToggleDebug": return _U.update(state,
           {debug: $Basics.not(state.debug)});
         default: return _U.update(state,{activeView: _p0._0});}
   });
   var ChangeView = function (a) {
      return {ctor: "ChangeView",_0: a};
   };
   var ToggleDebug = {ctor: "ToggleDebug"};
   var ToggleSubmit = {ctor: "ToggleSubmit"};
   var ToggleCCVFocus = {ctor: "ToggleCCVFocus"};
   var CCVEntry = function (a) {
      return {ctor: "CCVEntry",_0: a};
   };
   var ExpirationYearChange = function (a) {
      return {ctor: "ExpirationYearChange",_0: a};
   };
   var ExpirationMonthChange = function (a) {
      return {ctor: "ExpirationMonthChange",_0: a};
   };
   var HolderEntry = function (a) {
      return {ctor: "HolderEntry",_0: a};
   };
   var DigitEntry3 = function (a) {
      return {ctor: "DigitEntry3",_0: a};
   };
   var DigitEntry2 = function (a) {
      return {ctor: "DigitEntry2",_0: a};
   };
   var DigitEntry1 = function (a) {
      return {ctor: "DigitEntry1",_0: a};
   };
   var DigitEntry0 = function (a) {
      return {ctor: "DigitEntry0",_0: a};
   };
   ...
   var update = F2(function (action,model) {
      ...
      {case "NoOp": return model;
         ...
         case "Decrement": return _U.update(model,
           {counter: model.counter - 1});
         default: return _U.update(model,{creditCard: _p1._0});}
   });
   var CardSubmitted = function (a) {
      return {ctor: "CardSubmitted",_0: a};
   };
   var Decrement = {ctor: "Decrement"};
   var Increment = {ctor: "Increment"};
   var NoOp = {ctor: "NoOp"};
   var cardExpirationYear = function (state) {
      return A2($String.right,2,state.cardExpirationYear);
   };
   var cardExpirationMonth = function (state) {
      var _p2 = state.cardExpirationMonth;
      switch (_p2)
      {case "Jan": return "01";
         case "Feb": return "02";
         case "Mar": return "03";
   ...
   var cardExpirationDate = function (state) {
      return A2($Basics._op["++"],
      cardExpirationMonth(state),
      A2($Basics._op["++"],"/",cardExpirationYear(state)));
   };
   var cardNumber = function (state) {
      return A2($Basics._op["++"],
      state.cardNumber0,
      A2($Basics._op["++"],
      " ",
      ...
      A2($Basics._op["++"],
      state.cardNumber2,
      A2($Basics._op["++"]," ",state.cardNumber3))))));
   };
   var successView = F2(function (state,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("checkout modalbox success center animate")]),
      _U.list([A2($Html.div,
              _U.list([$Html$Attributes.$class("icon")]),
              _U.list([A2($Html.i,
              _U.list([$Html$Attributes.$class("fa fa-check")]),
              _U.list([]))]))
              ,A2($Html.h1,_U.list([]),_U.list([$Html.text("Success!")]))
              ,A2($Html.p,
              _U.list([]),
              _U.list([$Html.text("We\'ve sent a confirmation to your e-mail.")]))]));
   });
   var events = $Signal.mailbox(Never);
   var debugView = F2(function (state,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class(A2($Basics._op["++"],
              "debug",
              state.debug ? " active" : ""))
              ,A2($Html$Events.onDoubleClick,events.address,ToggleDebug)]),
      _U.list([$Html.text(A2($Basics._op["++"],
              "state: ",
              $Basics.toString(state)))
              ,A2($Html.br,_U.list([]),_U.list([]))
              ,$Html.text(A2($Basics._op["++"],
              "model: ",
              $Basics.toString(model)))]));
   });
   var toggleSubmit = A2($Signal.send,events.address,ToggleSubmit);
   var changeViewTo = function (newView) {
      return A2($Signal.send,events.address,ChangeView(newView));
   };
   var actions = $Signal.mailbox(NoOp);
   var inputs = function () {
      var clicks = A2($Signal.map,
      $Basics.always(Increment),
      $Mouse.clicks);
      var toAction = function (n) {
         var _p3 = n;
         switch (_p3)
      ...
      $Keyboard.arrows);
      var arrows = A2($Signal.sampleOn,
      delta,
      A2($Signal.map,toAction,x));
      return $Signal.mergeMany(_U.list([actions.signal
                                       ,arrows
                                       ,clicks]));
   }();
   var updateCardDetails = function (card) {
      return A2($Signal.send,actions.address,CardSubmitted(card));
   };
   var Fail = function (a) {    return {ctor: "Fail",_0: a};};
   var Success = {ctor: "Success"};
   var CreditCardForm = {ctor: "CreditCardForm"};
   var failView = F3(function (error,state,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("checkout modalbox error center animate")]),
      _U.list([A2($Html.div,
              _U.list([$Html$Attributes.$class("icon")]),
              _U.list([A2($Html.i,
              _U.list([$Html$Attributes.$class("fa fa-times")]),
              _U.list([]))]))
              ,A2($Html.h1,_U.list([]),_U.list([$Html.text("Oh no!")]))
              ,A2($Html.p,
              _U.list([]),
              _U.list([$Html.text("Something went wrong, please try again.")]))
              ,A2($Html.button,
              _U.list([$Html$Attributes.$class("redo btn")
                      ,$Html$Attributes.type$("button")
                      ,A2($Html$Events.onClick,
                      events.address,
                      ChangeView(CreditCardForm))]),
              _U.list([$Html.text("Go back")]))
              ,A2($Html.span,
              _U.list([$Html$Attributes.$class("change")]),
              _U.list([$Html.text(A2($Basics._op["++"],
              "Error type: ",
              $Basics.toString(error)))]))]));
   });
   var initialViewState = {activeView: CreditCardForm
                          ,cardNumber0: ""
                          ,cardNumber1: ""
                          ,cardNumber2: ""
                          ,cardNumber3: ""
   ...
   var CreditCard = F4(function (a,b,c,d) {
      return {number: a,holder: b,expiration: c,ccv: d};
   });
   var initialModel = {counter: 0
                      ,creditCard: A4(CreditCard,"","","","")};
   var model = A3($Signal.foldp,update,initialModel,inputs);
   var creditCardDecoder = A5($Json$Decode.object4,
   CreditCard,
   A2($Json$Decode._op[":="],"number",$Json$Decode.string),
   A2($Json$Decode._op[":="],"holder",$Json$Decode.string),
   A2($Json$Decode._op[":="],"expiration",$Json$Decode.string),
   A2($Json$Decode._op[":="],"ccv",$Json$Decode.string));
   var responseDecoder = A2($Json$Decode.object1,
   Payload,
   A2($Json$Decode._op[":="],"card",creditCardDecoder));
   var postForm = function (state) {
      var url = "https://elm.herokuapp.com/api";
      var creditCard = A4(CreditCard,
      cardNumber(state),
      state.cardHolderName,
      cardExpirationDate(state),
      state.cardCCV);
      var body = $Http.multipart(_U.list([A2($Http.stringData,
                                         "card[number]",
                                         creditCard.number)
                                         ,A2($Http.stringData,"card[holder]",creditCard.holder)
                                         ,A2($Http.stringData,"card[expiration]",creditCard.expiration)
                                         ,A2($Http.stringData,"card[ccv]",creditCard.ccv)]));
      return A3($Http.post,responseDecoder,url,body);
   };
   var submit = function (state) {
      ...
      toggleSubmit,
      function (_p4) {
         return postForm(state);
      }),
      function (_p5) {
         var _p6 = _p5;
         return updateCardDetails(_p6.card);
      }),
      function (_p7) {
         return changeViewTo(Success);
      }),
      function (err) {
         return A2($Task.andThen,
   ...
   var creditCardForm = F2(function (state,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("checkout")]),
      _U.list([A2($Html.div,
              _U.list([$Html$Attributes.$class(A2($Basics._op["++"],
              "credit-card-box",
              state.cardCCVfocused ? " hover" : ""))]),
              _U.list([A2($Html.div,
              _U.list([$Html$Attributes.$class("flip")]),
              _U.list([A2($Html.div,
                      _U.list([$Html$Attributes.$class("front")]),
                      _U.list([A2($Html.div,
                              _U.list([$Html$Attributes.$class("chip")]),
                              _U.list([]))
                              ,A2($Html.div,
                              _U.list([$Html$Attributes.$class("logo")]),
                              _U.list([A2($Html.img,
                              _U.list([$Html$Attributes.alt("")
                                      ,$Html$Attributes.src("http://cdn.flaticon.com/svg/39/39134.svg")]),
                              _U.list([]))]))
                              ,A2($Html.div,
                              _U.list([$Html$Attributes.$class("number")]),
                              _U.list([$Html.text(cardNumber(state))]))
                              ,A2($Html.div,
                              _U.list([$Html$Attributes.$class("card-holder")]),
                              _U.list([A2($Html.label,
                                      _U.list([]),
                                      _U.list([$Html.text("Card holder")]))
                                      ,A2($Html.div,
                                      _U.list([]),
                                      _U.list([$Html.text(state.cardHolderName)]))]))
                              ,A2($Html.div,
                              _U.list([$Html$Attributes.$class("card-expiration-date")]),
                              _U.list([A2($Html.label,
                                      _U.list([]),
                                      _U.list([$Html.text("Expires")]))
                                      ,A2($Html.div,
                                      _U.list([]),
                                      _U.list([$Html.text(cardExpirationDate(state))]))]))]))
                      ,A2($Html.div,
                      _U.list([$Html$Attributes.$class("back")]),
                      _U.list([A2($Html.div,
                              _U.list([$Html$Attributes.$class("strip")]),
                              _U.list([]))
                              ,A2($Html.div,
                              _U.list([$Html$Attributes.$class("logo")]),
                              _U.list([A2($Html.img,
                              ...
                              _U.list([]))]))
                              ,A2($Html.div,
                              _U.list([$Html$Attributes.$class("ccv")]),
                              _U.list([A2($Html.label,
                                      _U.list([]),
                                      _U.list([$Html.text("CCV")]))
                                      ,A2($Html.div,
                                      _U.list([]),
                                      _U.list([$Html.text(state.cardCCV)]))]))]))]))]))
              ,A2($Html.form,
              _U.list([$Html$Attributes.$class("form")
                      ...
                      function (_p9) {
                         ...
                         tasksMailbox.address,
                         submit(state));
                      })]),
              _U.list([A2($Html.fieldset,
                      _U.list([$Html$Attributes.$class("card-number-inputs")
                              ,$Html$Attributes.disabled(state.submitting)]),
                      _U.list([A2($Html.label,
                              _U.list([$Html$Attributes.$for("card-number")]),
                              _U.list([$Html.text("Card Number")]))
                              ,A2($Html.input,
                              _U.list([$Html$Attributes.$class("input-card-number")
                                      ,$Html$Attributes.id("card-number0")
                                      ,$Html$Attributes.required(true)
                                      ,$Html$Attributes.pattern("\\d{4}")
                                      ...
                                      function (digit) {
                                         return A2($Signal.message,
                                         events.address,
                                         DigitEntry0(A2($String.filter,$Char.isDigit,digit)));
                                      })
                                      ,$Html$Attributes.value(state.cardNumber0)]),
                              _U.list([]))
                              ,A2($Html.input,
                              _U.list([$Html$Attributes.$class("input-card-number")
                                      ,$Html$Attributes.id("card-number1")
                                      ,$Html$Attributes.required(true)
                                      ,$Html$Attributes.pattern("\\d{4}")
                                      ,$Html$Attributes.maxlength(4)
                                      ,$Html$Attributes.type$("text")
                                      ...
                                      function (digit) {
                                         return A2($Signal.message,
                                         events.address,
                                         DigitEntry1(A2($String.filter,$Char.isDigit,digit)));
                                      })
                                      ,A2($Html$Attributes.attribute,
                                      "data-autofocus",
                                      $Basics.toString(_U.cmp($String.length(state.cardNumber0),
                                      3) > 0))
                                      ,$Html$Attributes.value(state.cardNumber1)]),
                              _U.list([]))
                              ,A2($Html.input,
                              _U.list([$Html$Attributes.$class("input-card-number")
                                      ,$Html$Attributes.id("card-number2")
                                      ,$Html$Attributes.required(true)
                                      ,$Html$Attributes.pattern("\\d{4}")
                                      ,$Html$Attributes.maxlength(4)
                                      ,$Html$Attributes.type$("text")
                                      ...
                                      function (digit) {
                                         return A2($Signal.message,
                                         events.address,
                                         DigitEntry2(A2($String.filter,$Char.isDigit,digit)));
                                      })
                                      ,A2($Html$Attributes.attribute,
                                      "data-autofocus",
                                      $Basics.toString(_U.cmp($String.length(state.cardNumber1),
                                      3) > 0))
                                      ,$Html$Attributes.value(state.cardNumber2)]),
                              _U.list([]))
                              ,A2($Html.input,
                              _U.list([$Html$Attributes.$class("input-card-number")
                                      ,$Html$Attributes.id("card-number3")
                                      ,$Html$Attributes.required(true)
                                      ,$Html$Attributes.pattern("\\d{4}")
                                      ,$Html$Attributes.maxlength(4)
                                      ,$Html$Attributes.type$("text")
                                      ...
                                      function (digit) {
                                         return A2($Signal.message,
                                         events.address,
                                         DigitEntry3(A2($String.filter,$Char.isDigit,digit)));
                                      })
                                      ,A2($Html$Attributes.attribute,
                                      "data-autofocus",
                                      $Basics.toString(_U.cmp($String.length(state.cardNumber2),
                                      3) > 0))
                                      ,$Html$Attributes.value(state.cardNumber3)]),
                              _U.list([]))]))
                      ,A2($Html.fieldset,
                      _U.list([$Html$Attributes.disabled(state.submitting)]),
                      _U.list([A2($Html.label,
                              _U.list([$Html$Attributes.$for("card-holder")]),
                              _U.list([$Html.text("Card holder")]))
                              ,A2($Html.input,
                              _U.list([$Html$Attributes.id("card-holder")
                                      ,$Html$Attributes.required(true)
                                      ,$Html$Attributes.pattern("\\D+")
                                      ...
                                      $Html$Events.targetValue,
                                      function (entry) {
                                         return A2($Signal.message,events.address,HolderEntry(entry));
                                      })
                                      ,$Html$Attributes.value(state.cardHolderName)]),
                              _U.list([]))]))
                      ,A2($Html.fieldset,
                      _U.list([$Html$Attributes.$class("fieldset-expiration")
                              ,$Html$Attributes.disabled(state.submitting)]),
                      _U.list([A2($Html.label,
                              _U.list([$Html$Attributes.$for("card-expiration-month")]),
                              _U.list([$Html.text("Expiration date")]))
                              ,A2($Html.div,
                              _U.list([$Html$Attributes.$class("select")]),
                              _U.list([A2($Html.select,
                              _U.list([$Html$Attributes.id("card-expiration-month")
                                      ,$Html$Attributes.required(true)
                                      ,A3($Html$Events.on,
                                      "input",
                                      $Html$Events.targetValue,
                                      function (month) {
                                         return A2($Signal.message,
                                         events.address,
                                         ExpirationMonthChange(month));
                                      })
                                      ,$Html$Attributes.value(state.cardExpirationMonth)]),
                              _U.list([A2($Html.option,_U.list([]),_U.list([]))
                                      ,A2($Html.option,
                                      _U.list([$Html$Attributes.selected(_U.eq(state.cardExpirationMonth,
                                      "Jan"))]),
                                      _U.list([$Html.text("Jan")]))
                                      ,A2($Html.option,
                                      _U.list([$Html$Attributes.selected(_U.eq(state.cardExpirationMonth,
                                      "Feb"))]),
                                      _U.list([$Html.text("Feb")]))
                                      ,A2($Html.option,
                                      _U.list([$Html$Attributes.selected(_U.eq(state.cardExpirationMonth,
                                      "Mar"))]),
                                      _U.list([$Html.text("Mar")]))
                                      ,A2($Html.option,
                                      _U.list([$Html$Attributes.selected(_U.eq(state.cardExpirationMonth,
                                      "Apr"))]),
                                      _U.list([$Html.text("Apr")]))
                                      ,A2($Html.option,
                                      _U.list([$Html$Attributes.selected(_U.eq(state.cardExpirationMonth,
                                      "May"))]),
                                      _U.list([$Html.text("May")]))
                                      ,A2($Html.option,
                                      _U.list([$Html$Attributes.selected(_U.eq(state.cardExpirationMonth,
                                      "Jun"))]),
                                      _U.list([$Html.text("Jun")]))
                                      ,A2($Html.option,
                                      _U.list([$Html$Attributes.selected(_U.eq(state.cardExpirationMonth,
                                      "Jul"))]),
                                      _U.list([$Html.text("Jul")]))
                                      ,A2($Html.option,
                                      _U.list([$Html$Attributes.selected(_U.eq(state.cardExpirationMonth,
                                      "Ago"))]),
                                      _U.list([$Html.text("Ago")]))
                                      ,A2($Html.option,
                                      _U.list([$Html$Attributes.selected(_U.eq(state.cardExpirationMonth,
                                      "Sep"))]),
                                      _U.list([$Html.text("Sep")]))
                                      ,A2($Html.option,
                                      _U.list([$Html$Attributes.selected(_U.eq(state.cardExpirationMonth,
                                      "Oct"))]),
                                      _U.list([$Html.text("Oct")]))
                                      ,A2($Html.option,
                                      _U.list([$Html$Attributes.selected(_U.eq(state.cardExpirationMonth,
                                      "Nov"))]),
                                      _U.list([$Html.text("Nov")]))
                                      ,A2($Html.option,
                                      _U.list([$Html$Attributes.selected(_U.eq(state.cardExpirationMonth,
                                      "Dec"))]),
                                      _U.list([$Html.text("Dec")]))]))]))
                              ,A2($Html.div,
                              _U.list([$Html$Attributes.$class("select")]),
                              _U.list([A2($Html.select,
                              _U.list([$Html$Attributes.id("card-expiration-year")
                                      ,$Html$Attributes.required(true)
                                      ,A3($Html$Events.on,
                                      "input",
                                      $Html$Events.targetValue,
                                      ...
                                      ,$Html$Attributes.value(state.cardExpirationYear)]),
                              _U.list([A2($Html.option,_U.list([]),_U.list([]))
                                      ,A2($Html.option,
                                      _U.list([$Html$Attributes.selected(_U.eq(state.cardExpirationYear,
                                      "2016"))]),
                                      _U.list([$Html.text("2016")]))
                                      ,A2($Html.option,
                                      _U.list([$Html$Attributes.selected(_U.eq(state.cardExpirationYear,
                                      "2017"))]),
                                      _U.list([$Html.text("2017")]))
                                      ,A2($Html.option,
                                      _U.list([$Html$Attributes.selected(_U.eq(state.cardExpirationYear,
                                      "2018"))]),
                                      _U.list([$Html.text("2018")]))
                                      ,A2($Html.option,
                                      _U.list([$Html$Attributes.selected(_U.eq(state.cardExpirationYear,
                                      "2019"))]),
                                      _U.list([$Html.text("2019")]))
                                      ,A2($Html.option,
                                      _U.list([$Html$Attributes.selected(_U.eq(state.cardExpirationYear,
                                      "2020"))]),
                                      _U.list([$Html.text("2020")]))
                                      ,A2($Html.option,
                                      _U.list([$Html$Attributes.selected(_U.eq(state.cardExpirationYear,
                                      "2021"))]),
                                      _U.list([$Html.text("2021")]))
                                      ,A2($Html.option,
                                      _U.list([$Html$Attributes.selected(_U.eq(state.cardExpirationYear,
                                      "2022"))]),
                                      _U.list([$Html.text("2022")]))
                                      ,A2($Html.option,
                                      _U.list([$Html$Attributes.selected(_U.eq(state.cardExpirationYear,
                                      "2023"))]),
                                      _U.list([$Html.text("2023")]))
                                      ,A2($Html.option,
                                      _U.list([$Html$Attributes.selected(_U.eq(state.cardExpirationYear,
                                      "2024"))]),
                                      _U.list([$Html.text("2024")]))
                                      ,A2($Html.option,
                                      _U.list([$Html$Attributes.selected(_U.eq(state.cardExpirationYear,
                                      "2025"))]),
                                      _U.list([$Html.text("2025")]))]))]))]))
                      ,A2($Html.fieldset,
                      _U.list([$Html$Attributes.$class("fieldset-ccv")
                              ,$Html$Attributes.disabled(state.submitting)]),
                      _U.list([A2($Html.label,
                              _U.list([$Html$Attributes.$for("card-ccv")]),
                              _U.list([$Html.text("CCV")]))
                              ,A2($Html.input,
                              _U.list([$Html$Attributes.id("card-ccv")
                                      ,$Html$Attributes.required(true)
                                      ...
                                      function (entry) {
                                         return A2($Signal.message,
                                         events.address,
                                         CCVEntry(A2($String.filter,$Char.isDigit,entry)));
                                      })
                                      ,A2($Html$Events.onFocus,events.address,ToggleCCVFocus)
                                      ,A2($Html$Events.onBlur,events.address,ToggleCCVFocus)
                                      ,$Html$Attributes.value(state.cardCCV)]),
                              _U.list([]))]))
                      ,A2($Html.button,
                      _U.list([$Html$Attributes.$class("btn")
                              ,$Html$Attributes.disabled(state.submitting)]),
                      _U.list([state.submitting ? A2($Html.i,
                              _U.list([$Html$Attributes.$class("fa fa-cog fa-spin")]),
                              _U.list([])) : $Html.text("")
                              ,$Html.text("Submit")]))]))]));
   });
   var activeView = function (view) {
      var _p10 = view;
      switch (_p10.ctor)
      {case "CreditCardForm": return creditCardForm;
         case "Success": return successView;
         default: return failView(_p10._0);}
   };
   var view = F2(function (state,model) {
      return A2($Html.div,
      _U.list([]),
      _U.list([A3(activeView,state.activeView,state,model)
              ,A2(debugView,state,model)]));
   });
   var main = A3($Signal.map2,view,viewState,model);
   var Model = F2(function (a,b) {
      return {counter: a,creditCard: b};
   });
   return _elm.Main.values = {_op: _op
                             ...
                             ,update: update
                             ,Never: Never
                             ,DigitEntry0: DigitEntry0
                             ,DigitEntry1: DigitEntry1
                             ,DigitEntry2: DigitEntry2
                             ,DigitEntry3: DigitEntry3
                             ,HolderEntry: HolderEntry
                             ,ExpirationMonthChange: ExpirationMonthChange
                             ,ExpirationYearChange: ExpirationYearChange
                             ,CCVEntry: CCVEntry
                             ,ToggleCCVFocus: ToggleCCVFocus
                             ...
                             ,creditCardDecoder: creditCardDecoder
                             ,submit: submit
                             ,toggleSubmit: toggleSubmit
                             ,updateCardDetails: updateCardDetails
                             ,changeViewTo: changeViewTo
                             ,tasksMailbox: tasksMailbox};
};
